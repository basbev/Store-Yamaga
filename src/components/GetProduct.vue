<template>
  <div class="hello container">
    <img src = "/static/shop.jpg" width="800">
    <div class=" is-size-2 center">เพิ่มสินค้า</div>
    <div class="columns">
      <div class="column is-offset-2 is-2">
        <b-field label="Product Name">
          <b-input v-model="name" placeholder="ชื่อสินค้า"></b-input>
        </b-field>
      </div>

      <div class="column is-2">
        <b-field label="Product Price" expanded>
          <b-input type="number" v-model="price" placeholder="ราคาสินค้า"></b-input>
        </b-field>
      </div>

      <div class="column is-2">
        <b-field label="Product Number" expanded>
          <b-input type="number" v-model="amount" placeholder="จำนวนสินค้า"></b-input>
        </b-field>
      </div>
      ...
      <div class="column is-2">
        <b-field class="file buttonImage">
          ...
          <span class="file-name" v-if="files && files.length" style="padding-right: 140px;">
            {{ files[0].name }}
          </span>
        </b-field>
      </div>
    ...
    <div class="columns is-centered">
      <div class="column is-4">
        <a class="button is-danger is-outlined" @click="insertProduct(name, price, amount,files[0])">ยืนยัน</a>
        <a class="button is-info is-outlined" @click="clearproduct()">ยกเลิก</a>
        <router-link to='/'><a class="button is-success is-outlined">หน้าสินค้า</a></router-link>
